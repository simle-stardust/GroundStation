...
static const uint32_t AES_E1[256] = {
...
static const uint32_t AES_E2[256] = {
...
static const uint32_t AES_E3[256] = {
...
static const uint32_t AES_E4[256] = {
...
static uint32_t AESAUX[16/sizeof(uint32_t)];
static uint32_t AESKEY[11*16/sizeof(uint32_t)];
...
/*
static uint16_t os_rlsbf2 (const uint8_t * buf) {
    return (uint16_t)(buf[0] | (buf[1]<<8));
}
*/
/*
static uint32_t os_rlsbf4 (const uint8_t * buf) {
    return (uint32_t)(buf[0] | (buf[1]<<8) | ((uint32_t)buf[2]<<16) | ((uint32_t)buf[3]<<24));
}
*/

static uint32_t os_rmsbf4 (const uint8_t * buf) {
...
static void os_wmsbf4 (uint8_t * buf, uint32_t v) {
    buf[3] = v;
    buf[2] = v>>8;
    buf[1] = v>>16;
    buf[0] = v>>24;
...
static uint32_t os_aes (uint8_t mode, uint8_t * buf, uint16_t len) {
